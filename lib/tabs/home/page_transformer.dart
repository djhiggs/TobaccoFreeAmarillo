...
// A class that can be used to compute visibility information about the current page
class PageVisibilityResolver {
  ...
  double _calculatePagePosition(int index) {
    final double viewPortFraction = _viewPortFraction ?? 0.5;
    final double pageViewWidth =
        (_pageMetrics?.viewportDimension ?? 0.5) * viewPortFraction;
